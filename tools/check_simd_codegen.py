...
HELPERS = (
    ...
    {
        "name": "filter6_u8x16",
        "symbol": "vp8_kernels_simd_filter6_u8x16",
        "kind": "helper",
        "vector_structs": ("struct uya_simd_vector_uint8_t_16",),
    },
    {
        "name": "loopfilter_edge_u8x16",
        "symbol": "vp8_kernels_simd_loopfilter_edge_u8x16",
        "kind": "helper",
        "vector_structs": ("struct uya_simd_vector_uint8_t_16",),
    },
)
...
SIMD_KERNELS = (
    ...
    {
        "name": "predict_luma_subpixel_vertical_u8x16",
        "symbol": "vp8_kernels_simd_predict_luma_subpixel_vertical_u8x16",
    },
    {
        "name": "loop_filter_simple_vertical_edge_u8x16",
        "symbol": "vp8_kernels_simd_loop_filter_simple_vertical_edge_u8x16",
    },
    {
        "name": "loop_filter_simple_horizontal_edge_u8x16",
...
- {len(c_results)} 个 portable SIMD helper 都生成了稳定的 C 符号。
