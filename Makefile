...
.PHONY: all build check check-toolchain test test-decoder-scalar test-tiny-md5 test-keyframe-md5 test-inter-md5 test-non16-md5 test-segmentation-md5 test-token-partition-md5 test-vpxdiff clean require-uya
