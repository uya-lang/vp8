...
| loopfilter_edge_u8x16 | `vp8_kernels_simd_loopfilter_edge_u8x16` | `struct uya_simd_vector_uint8_t_16` | symbol |

检查结果：

- 15 个 portable SIMD helper 都生成了稳定的 C 符号。
