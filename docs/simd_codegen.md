...
- 当前 plane copy/fill/border extension/inter copy/sub-pixel horizontal/vertical/residual add clamp/DC-only inverse transform/4x4 inverse DCT batch/Y16x16/Y4x4/UV8x8 predictor SIMD kernel 都生成了稳定 C 符号，并在汇编快照中检测到对应 label。
